        ...
        public void run() {
            while (true) {
                try {
                    ...
                    String c =  new String(pacote.getData().toString());
                            
                    System.out.println("Chegou informações de um componente... precisamos redesenha-lo no frame: " + c);
//                   
//                    
//      
//                    Componente componente = (Componente)oos.readObject();
